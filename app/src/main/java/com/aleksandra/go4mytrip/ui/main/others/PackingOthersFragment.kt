...
class PackingOthersFragment : Fragment(), PackingOthersContract.View{
    ...
    val presenter by lazy { PackingOthersPresenter(this)}
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.tab_packing_others, container, false)
