 ...
 */
public class PackingToiletriesFragment extends Fragment {
    ...
    public static PackingToiletriesFragment newInstance(int index) {
        PackingToiletriesFragment fragment = new PackingToiletriesFragment();
    ...
    public View onCreateView(
        ...
        View root = inflater.inflate(R.layout.tab_packing_toiletries, container, false);
        ...
        referencePackingList.child(uid).child("trips").child(idTrip).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot packingSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if (packingModel.getCategory().equals("Toiletries")) {
